...
const Showcase = () => {
  return (
    <Box sx={{
        ...
        <p className='text-[18px] text-[#404040]'>100K+ venture-backed and bootstrapped startups build with Zikora</p>

        <Box className='flex flex-row w-[83%] justify-between align-bottom mt-[2.5rem] '>
