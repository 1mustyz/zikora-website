  ...
  return (
    ...
    >
        ...
        rightPic={loanPic6} leftBg="#E8ECE3" rightBg="#404040">
          <>
            <Typography sx={{fontSize: '24px', color: '#404040', fontWeight: '500'}}>Zikora Overdraft</Typography>
              <Typography sx={{color: '#5E5E5E', fontSize: '18px', lineHeight: '2rem'}}>
          ...
          <>
            <Typography sx={{fontSize: '24px', color: 'white', fontWeight: '500'}}>Corporate Cash Advance</Typography>
              <Typography sx={{color: 'white', fontSize: '18px', lineHeight: '2rem'}}>
        ...
        <CustomPlate leftPic={loanPic3}
          ...
          <>
            <Typography sx={{fontSize: '24px', color: '#404040', fontWeight: '500'}}>Retail Loans</Typography>
              <Typography sx={{color: '#5E5E5E', fontSize: '18px', lineHeight: '2rem'}}>
          ...
          <>
            <Typography sx={{fontSize: '24px', color: '#404040', fontWeight: '500'}}>Asset Acquisation Financing</Typography>
              <Typography sx={{color: '#5E5E5E', fontSize: '18px', lineHeight: '2rem'}}>
        ...
        <CustomPlate leftPic={loanPic5}
          ...
          <>
            <Typography sx={{fontSize: '24px', color: 'white', fontWeight: '500'}}>Bridge Loan Finance</Typography>
              <Typography sx={{color: 'white', fontSize: '18px', lineHeight: '2rem'}}>
          ...
          <>
            <Typography sx={{fontSize: '24px', color: '#404040', fontWeight: '500'}}>Staff Loan</Typography>
              <Typography sx={{color: '#5E5E5E', fontSize: '18px', lineHeight: '2rem'}}>
