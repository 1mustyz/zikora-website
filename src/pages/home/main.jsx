    ...
    >
      ...
      <div className="flex flex-row mt-5  justify-between sm:flex-col sm:px-[1.2rem] ">
        ...
        <div className="mt-20 sm:mt-[1rem] w-1/2 flex flex-col h-full sm:w-full ">
          ...
          <Box className="mt-10 sm:mt-[1.2rem] leading-1 text-xl sm:text-[14px] opacity-75">
            Zikora is a people-first, digital-led bank, serving communities in
            Nigeria by providing access to reliable banking services
          </Box>
