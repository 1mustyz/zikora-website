  ...
  return (
    <div className='flex flex-col w-[90vw] m-[auto] mt-[6rem] sm:mt-[3rem]'>
        ...
        <HeadingAndText>
            ...
            <>This Privacy Policy applies to Zikora MFB (“we” or “us” or “our”). Zikora MFB recognizes the importance of protecting your personal and financial information and is committed to doing this.This Privacy Policy sets out how we collect, handle, store and protect information about you when: ·We provide products or services to you or our client; ·You visit or use our website; and/or·Performing any other activities that form part of our business.</>
        ...
        <HeadingAndText>
            ...
            <>In some cases, we may also collect personal information about you indirectly from third parties including but not limited to: 
                <p>1. your employer;</p>
                <p>2. third parties such as providers of ‘know your client’ and anti-money laundering services which we use to help us meet our legal requirements in this area and to help us verify your identity where we provide you with products or services;</p>
                <p>3. background check providers which we sometimes use to verify your identity when you apply for a product of ours;</p>
                <p>4. third party service providers that help us to operate our website;</p>
                <p className='mb-[2rem]'>5.  your banks and financial institutions.</p>
            </>
        </HeadingAndText>
